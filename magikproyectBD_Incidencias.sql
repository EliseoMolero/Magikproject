CREATE DATABASE  IF NOT EXISTS `magikproyectBD` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `magikproyectBD`;
-- MySQL dump 10.13  Distrib 5.7.17, for Linux (x86_64)
--
-- Host: localhost    Database: magikproyectBD
-- ------------------------------------------------------
...
-- Dump completed on 2017-06-08 17:05:19
